...
BOT_TOKEN = getenv("BOT_TOKEN", "8101342124:AAGROKmzcNydFlIMlDV8-aGDDSdv8Mtpfr4")
BOT_NAME = getenv("BOT_NAME", "My 🎤 bot")
...
OWNER_NAME = getenv("OWNER_NAME", "OGYY")
OWNER_USERNAME = getenv("OWNER_USERNAME", "BGMI_OWNER9050")
ALIVE_NAME = getenv("ALIVE_NAME", "oggy")
BOT_USERNAME = getenv("BOT_USERNAME", "my_bot_9050_bot")
OWNER_ID = getenv("OWNER_ID", "1669178360")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "𝙊𝙂𝙔𝙔 𝙋𝙍𝙄𝙈𝙀")
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "8018964088").split()))
